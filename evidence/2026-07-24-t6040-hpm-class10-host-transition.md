...
Follow-up PAC-aware decoding in ticket 096 names those calls precisely:
`createUSB3PortObject`, `setPinConfiguration`, conditional
`handleDetectChange(false)`, unconditional `handleDetectChange(true)`, the
