...
#  smaller than 64 this WORKS outright (reduced parallelism); if wrap semantics are broken it
#  crashes faster (~head 13-15) and tells us so. m1n1 prefix/dtb/image identical to v6.
